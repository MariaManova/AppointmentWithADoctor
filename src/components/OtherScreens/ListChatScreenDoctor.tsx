...
class ListChatScreenDoctor extends React.Component<any, State> {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      if (param) id = param;
      if (token) {
        const response = await fetch(serverUrl + 'chat?id_Doctor='  + userLogin.id,
          {
