...
import { Patient, initPatient, DoctorChat } from '../../interfaces'
...
class ListChatScreenPatient extends React.Component<any, State> {
    ...
    return (
      ...
      {history.map((item: DoctorChat, id) => {
       // return <Text>Message</Text> 
            return <DoctorACardTwo data={item} key={id} 
            onPress={() => navigation.navigate(CHATTWO, (item))}/>
          })}
      </List.Accordion>
    </List.Section>
    )
